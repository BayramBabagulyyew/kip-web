<template>
  <div class="admin-news">
    <admin-header>Presentations</admin-header>
...
export default {
  ...
  components: {
    Add: () => import('~/components/adminka/AdminPresentation.vue'),
    List: () => import('~/components/adminka/AdminPresentationList.vue'),
  },
  computed: {
    currentComponent() {
  ...
  methods: {
    setView(view, item = {}) {
      this.$setView(view, item.presentationId);
    },
  },
};
</script>
